              ...
              <div className="p-4 pt-0">
                {item.price > 0 ? (
                  <button
                    ...
                    disabled={!!addingId}
                    className="w-full bg-black hover:bg-gray-900 text-white font-medium py-2 px-3 rounded-lg transition-colors disabled:opacity-50 flex items-center justify-center gap-2 text-sm"
                  >
                    {addingId === item.id ? (
                      <>
                        <svg

...
export default function ProductFilters({ marcas, minPrice, maxPrice, totalProducts }: ProductFiltersProps) {
  ...
  const hasActiveFilters = selectedMarca || priceRange.min || priceRange.max || inStockOnly;
